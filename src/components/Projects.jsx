    ...
    return ( 
        <div id="projects" className="mb-6">
            ...
            <div className="flex justify-evenly flex-wrap">
                ...
                <div key={project.id} className="max-w-sm tracking-wide pb-2 rounded-md overflow-hidden shadow-md shadow-white mx-2 my-4 h-fit sm:h-auto hover:shadow-lg hover:shadow-white">
